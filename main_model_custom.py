...
def main():
    ...
    spark = SparkSession.builder.appName("HotelReservationsCustomModel").getOrCreate()
    ...
    custom_model_trainer = CustomModelTrainer(config=config)

    custom_model_trainer.run()
    logger.info("Custom model training and registration process completed.")
